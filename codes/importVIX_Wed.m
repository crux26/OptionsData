...
%%
tic;
fileName = sprintf('%s\\VIXData_Wed.csv', rawData_path);
...
%%
caldt = T.caldt; caldt = datetime(caldt, 'ConvertFrom', 'yyyyMMdd'); caldt = datenum(caldt);
...
%% 
T_VIX_Wed = T;
save(sprintf('%s\\rawData_VIX_Wed.mat', genData_path), 'T_VIX_Wed');