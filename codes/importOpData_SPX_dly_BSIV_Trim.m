...
%%
varlen1 = length(CallData.Properties.VariableNames);
varlen2 = length(PutData.Properties.VariableNames);
CallData__ = cell2table(cell(0, varlen1), 'VariableNames', CallData.Properties.VariableNames);
PutData__ = cell2table(cell(0, varlen2), 'VariableNames', PutData.Properties.VariableNames);
clear varlen1 varlen2;
%%
