function IV = NewtonRaphson_put(S, K, r, tau, price, q, x0, tol)
...
% Havign direct error bound on IV would be problematic.
% What if IV_true = 1, whereas init_guess = .3?
% Whether to take it or not should be judged on the $ price, not IV.
